// Tiny stroke glyphs — a consistent, icon-slop-free set drawn on a 24×24 grid.
// Ported from the reference design.
export default function Glyph({ name, size = 20, stroke = 1.8, style }) {
  const p = {
    fill: 'none',
    stroke: 'currentColor',
    strokeWidth: stroke,
  ...
  const body = {
    ...
    warn: (
      <g {...p}>
        <path d="M12 3.2 L21.5 19.5 H2.5 Z" />
        <path d="M12 9.5v4.5" />
